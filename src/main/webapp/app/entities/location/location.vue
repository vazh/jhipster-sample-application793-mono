<template>
  <div>
    <h2 id="page-heading" data-cy="LocationHeading">
      <span v-text="$t('jhipsterSampleApplicationApp.location.home.title')" id="location-heading">Locations</span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="$t('jhipsterSampleApplicationApp.location.home.refreshListLabel')">Refresh List</span>
        </button>
        <router-link :to="{ name: 'LocationCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="$t('jhipsterSampleApplicationApp.location.home.createLabel')"> Create a new Location </span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && locations && locations.length === 0">
      <span v-text="$t('jhipsterSampleApplicationApp.location.home.notFound')">No locations found</span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('streetAddress')">
              <span v-text="$t('jhipsterSampleApplicationApp.location.streetAddress')">Street Address</span>
            ...
            <th scope="row" v-on:click="changeOrder('postalCode')">
              <span v-text="$t('jhipsterSampleApplicationApp.location.postalCode')">Postal Code</span>
            ...
            <th scope="row" v-on:click="changeOrder('city')">
              <span v-text="$t('jhipsterSampleApplicationApp.location.city')">City</span>
            ...
            <th scope="row" v-on:click="changeOrder('stateProvince')">
              <span v-text="$t('jhipsterSampleApplicationApp.location.stateProvince')">State Province</span>
            ...
            <th scope="row" v-on:click="changeOrder('country.id')">
              <span v-text="$t('jhipsterSampleApplicationApp.location.country')">Country</span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      ...
      <div class="modal-body">
        <p id="jhi-delete-location-heading" v-text="$t('jhipsterSampleApplicationApp.location.delete.question', { id: removeId })">
